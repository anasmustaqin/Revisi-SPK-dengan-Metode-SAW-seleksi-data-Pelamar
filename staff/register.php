...
<div class="accordion" id="accordionExample">
    <div class="accordion-item" align="center">
            ...
            <div id="collapseOne" class="accordion-collapse collapse show" data-bs-parent="#accordionExample">
                <div class="accordion-body">
                    <table border = "1" style = "font-size:medium;" width = "800px" align="center" class="table">
						...
						<tr>
							<td>NIK KTP</td>
							<td><input type="text" name="ktp" maxlength="16" placeholder="16 digit" class="form-control form-control-sm" onkeypress="return onlyNumberKey(event)" required></td>
						</tr>
						<tr>
							<td>Tempat Lahir</td>
        ...
        format xxxxxxxxxxxxx</small></td>
							<td><input type="tel" name="hp" placeholder="Diawali angka 0" class="form-control form-control-sm" maxlength="13" onkeypress="return onlyNumberKey(event)" required></td>
						</tr>
						<tr>
							<td>No WhatsApp<br><small id="passwordHelpBlock" class="form-text text-muted">
        format xxxxxxxxxxxxx</small></td>
							<td><input type="tel" name="wa" placeholder="Diawali angka 0" class="form-control form-control-sm" maxlength="13" onkeypress="return onlyNumberKey(event)" required></td>
						</tr>
						<tr>
							<td>Email:</td>
